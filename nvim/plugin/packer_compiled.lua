...
_G.packer_plugins = {
  ...
  neon = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/neon",
    url = "https://github.com/afamadriz/neon"
  },
  ["neoscroll.nvim"] = {
    loaded = true,
  ...
  ["nvim-treesitter-endwise"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-treesitter-endwise",
  ...
  onehalf = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/onehalf",
  ...
  ["vim-colors-pencil"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-colors-pencil",
    url = "https://github.com/preservim/vim-colors-pencil"
  },
  ["vim-enfocado"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-enfocado",
    url = "https://github.com/wuelnerdotexe/vim-enfocado"
  },
  ["vim-studio-dark"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-studio-dark",
